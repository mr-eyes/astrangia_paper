...
rule compute_dna_sigs:
    input:
        trimmed_sample = TRIMMED_SAMPLES + "/{sample}.trim.fq"
    output:
    ...
    shell: """
        sourmash sketch dna -p k=21,abund \
...
rule compute_prot_sigs:
    ...
    shell: """
        sourmash sketch translate -p k=21,abund \
...
rule Trimmomatic:
    ...
    shell: """
        trimmomatic PE -threads 32 -phred33 {input.r1_pe} {input.r2_pe} {params.OP_R1_PE} {params.OP_R1_SE} {params.OP_R2_PE} {params.OP_R2_SE} ILLUMINACLIP:{params.adap}/TruSeq3-PE-2.fa:2:30:10:1 SLIDINGWINDOW:4:2 MINLEN:25
